...
build-dev:
	docker compose -f $(BASE_COMPOSE_FILE) -f $(DEV_COMPOSE_FILE) build --no-cache
...
run-dev:
	...
	docker compose -f $(BASE_COMPOSE_FILE) -f $(DEV_COMPOSE_FILE) run --rm book_boy $(ARGS)
...
run-prod:
	...
	docker compose -f $(BASE_COMPOSE_FILE) -f $(PROD_COMPOSE_FILE) run --rm book_boy $(ARGS)
